...
function WatchListScreen(props) {
  ...
  const handleAddMovie = () => {
    ...
    let reviewText = "";
    let myratingText = "";
    Alert.prompt(selectedMovie.title, "Please leave a review", (review) => {
      if (review !== null) {
        reviewText = review;
        Alert.prompt(
          selectedMovie.title,
          ...
          (myrating) => {
            if (myrating !== null) {
              ...
              fetch(
                "https://thawing-shore-72198.herokuapp.com/remove-watchlist",
                {
                  method: "POST",
                ...
                fetch(
                  "https://thawing-shore-72198.herokuapp.com/add-mymovies-from-watchlist",
                  {
                    method: "POST",
