...
function HomeScreen2(props) {
  ...
  const [isRecommendedModalVisible, setIsRecommendedModalVisible] =
    useState(false);
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://thawing-shore-72198.herokuapp.com/friends"
        );
        if (response.ok) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.topContainer}>
        <View style={styles.bigcontainer}>
          ...
          <Text style={styles.tileText}>
            Welcome to the Film Club, the go-to app for all movie lovers out
            there!
          </Text>
        </View>
      ...
      <View style={styles.bottomContainer}>
        <View style={styles.rowContainer}>
          ...
          <HomeScreenTile
            ...
            icon={"film"}
            color={colours.third}
            onPress={toggleRecommendedModal}
          />
        </View>
      </View>
        ...
        <View style={styles.modalBackground}>
          ...
          <ScrollView>
            <Text style={styles.aboutText}>
              Welcome to the Film Club, the ultimate destination for movie
              lovers! Our app is designed to provide you with the latest
              information about the trending movies of the week, and to help you
              discover new movies based on your favorite genres. Whether you're
              a die-hard fan of action movies or you prefer to be transported to
              a different world with fantasy movies, our app has something for
              everyone.
            </Text>

            <Text style={styles.aboutText}>
              At the Film Club, we understand that watching movies is not just a
              form of entertainment, it's an experience. That's why we've
              created a platform that allows you to curate your own movie
              collection, and share your thoughts and opinions with others. With
              our search feature, you can easily find any movie you want and add
              it to your watchlist or your own personal list of favorite movies.
            </Text>

            <Text style={styles.aboutText}>
              We believe that the best part of watching a movie is being able to
              discuss it with others. That's why we've included a review
              feature, so you can share your thoughts on a movie with the rest
              of the Film Club community. Whether you loved a movie or you
              didn't enjoy it as much, we want to hear from you.
            </Text>

            <Text style={styles.aboutText}>
              The Film Club is more than just an app - it's a community of movie
              lovers who are passionate about the art of cinema. So join us
              today, and let's explore the world of movies together!
            </Text>
            <AppButton
              title="Close"
              onPress={toggleInfoModal}
          ...
          <View style={styles.modalImage}>
            ...
            <ScrollView style={{ backgroundColor: colours.primary }}>
              <Text style={styles.modalText}>
                See your friends favourite genres and top movie!
              </Text>
      ...
      <Modal visible={isRecommendedModalVisible} animationType="slide">
        <View style={styles.modalBackground}>
          <Text style={styles.modalText}>
            Discover movies from your favourite Genres !{" "}
          </Text>
          <Dropdown
