    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalView}>
          ...
          <AppButton
            onPress={() => handleSelection("Fiery Sunset")}
            title="Fiery Sunset"
          />
          <AppButton
            onPress={() => handleSelection("Ocean Breeze")}
            title="Ocean Breeze"
          />
          <AppButton
            onPress={() => handleSelection("Enchanted Forest")}
            title="Enchanted Forest"
          />
          <AppButton
            onPress={() => handleSelection("Golden Hour")}
            title="Golden Hour"
          />
          <AppButton
            onPress={() => handleSelection("Midnight Magic")}
